  ...
  <div className="w-full space-y-1.5">
    ...
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        'bg-secondary/50 px-3 py-2 text-sm',
...
>(({ className, children, position = 'popper', ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        'relative z-50 min-w-[8rem] overflow-hidden rounded-xl border border-border bg-card shadow-xl',
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      'outline-none focus:bg-secondary focus:text-foreground',
